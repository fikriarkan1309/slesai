...
export default function Finance({ tasks, projectsList, transactions, setTransactions }) {
  ...
  const [trxType, setTrxType] = useState('add'); // add, sub, transfer
  ...
  // 2. Hitung dari Transaksi Manual tombol utama
  ...
  // AKUMULASI: Total Kas Utama adalah gabungan saldo sisa + seluruh kas project
  ...
  // 3. SEEDING UNTUK LAPORAN MUTASI GABUNGAN (MANUAL + KANBAN TUGAS)
  ...
  combinedMutations.sort((a, b) => b.id - a.id); // Urutkan dari yang terbaru
    ...
    <div style={{ paddingBottom: '3rem' }}>
      <style>{`
        @media print {
          ...
          /* 1. BUKA KUNCI SCROLL TABEL AGAR MEMANJANG KE BAWAH */
          ...
          /* 2. PAKSA MUNCULKAN WARNA BACKGROUND & BORDER */
          * {
            -webkit-print-color-adjust: exact !important;
            print-color-adjust: exact !important;
          }

          /* 3. CEGAH BARIS TABEL TERPOTONG HALAMAN */
          table { page-break-inside: auto; width: 100%; }
          tr { page-break-inside: avoid; page-break-after: auto; }
          thead { display: table-header-group; }
          
          /* Rapikan sedikit margin widget saat dicetak */
      ...
      <div className="print-area">
        ...
        <div className="widget-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }} className="no-print">
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              ...
              <select value={filterType} onChange={e => setFilterType(e.target.value)} style={{ padding: '6px 12px', borderRadius: '6px', border: '1px solid #cbd5e1' }}>
                ...
                <option value="add">💰 Pemasukan Saja</option>
                <option value="sub">💸 Pengeluaran Saja</option>
          ...
          {/* --- BERIKAN PEMBUNGKUS SCROLL DI SINI --- */}
          <div className="finance-table-scroll" style={{ width: '100%', maxHeight: '580px', overflowY: 'auto', paddingRight: '4px' }}>
            ...
            {combinedMutations.filter(t => {
                ...
                // Ekstrak bulan dari string tanggal "YYYY-MM-DD"
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleTrxSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                <button type="submit" className="btn-primary" style={{ flex: 2, margin: 0 }}>Simpan Transaksi</button>
